...
const Sidebar: React.FC<SidebarProps> = ({ mobileNavOpen, setMobileNavOpen }) => {
    ...
    const navItems = [
        ...
        { to: '/livestreams', icon: icon("M17 10.5V7c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h12c.55 0 1-.45 1-1v-3.5l4 4v-11l-4 4z"), label: 'Прямые эфиры', visible: true },
