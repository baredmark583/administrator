        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <StatCard 
                    ...
                    value={getFormattedPrice(data.kpis.totalRevenueToday)} 
                ...
                <StatCard 
                    ...
                    icon={icon("M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.89-2-2-2zm-9 14l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z")}
                    color="text-sky-400"
                />
                 <StatCard 
